...
### Script qui fonctionne parfaitement bien
### Ne manqueraient que des commentaires pour bien comprendre ce qu'il fait et pourquoi

fichier = "avertissements_voyages_JHR.csv"
